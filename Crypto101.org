...
sizes, such as 128 bits, or $2^{128}$ (approximately $10^{38}$)
...
that required compatibility with DES.
...
#+BEGIN_LATEX
\illustration{ECBEncryptionOracle/RememberFirst}[1]
#+END_LATEX
...
#+BEGIN_LATEX
\illustration{ECBEncryptionOracle/GuessFirst}[1]
#+END_LATEX
...
#+BEGIN_LATEX
\illustration{ECBEncryptionOracle/RememberSecond}[1]
#+END_LATEX
...
#+BEGIN_LATEX
\illustration{ECBEncryptionOracle/GuessSecond}[1]
#+END_LATEX
